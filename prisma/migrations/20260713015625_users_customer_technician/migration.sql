...
*/
-- DropForeignKey
ALTER TABLE "customerProfiles" DROP CONSTRAINT "customerProfiles_userId_fkey";
...
-- AddForeignKey
ALTER TABLE "customerProfiles" ADD CONSTRAINT "customerProfiles_userId_fkey" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
